import { buildHangulWrapperHtml } from "./glyph-renderer.js";
...
export class HangulWorksheetApp {
  ...
  bindOrderToolbar() {
    $("#printTest").off("click.jamminHw").on("click.jamminHw", () => window.print());
  }
  ...
  bindWordListActions() {
    ...
    $("#wordList")
      .off("click.jamminHw")
      .on("click.jamminHw", "[data-hw-action]", function (e) {
